...
global para
set para(gui_mode) 1
set para(prj_dir) "Z:/es4/ES4-Final/VGA Test"
# synthesize IPs
# synthesize VMs
...
run_postsyn [list -a iCE40UP -p iCE40UP5K -t SG48 -sp High-Performance_1.2V -oc Industrial -top -w -o ES4_Lab_7_impl_1_syn.udb ES4_Lab_7_impl_1.vm] "Z:/es4/ES4-Final/VGA Test/impl_1/ES4_Lab_7_impl_1.ldc"
