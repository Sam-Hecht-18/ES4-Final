...
global para
set para(gui_mode) 1
set para(prj_dir) "Z:/ES4-Final/collisions_and_rotations"
# synthesize IPs
# synthesize VMs
...
run_postsyn [list -a iCE40UP -p iCE40UP5K -t SG48 -sp High-Performance_1.2V -oc Industrial -top -w -o collisions_and_rotations_impl_1_syn.udb collisions_and_rotations_impl_1.vm] "Z:/ES4-Final/collisions_and_rotations/impl_1/collisions_and_rotations_impl_1.ldc"
